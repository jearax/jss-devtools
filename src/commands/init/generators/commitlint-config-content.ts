...
// Plugin: regex-based header validation. Combines TICKET and CONVENTIONAL
// formats into one OR rule. To add more header formats, append another
// regex constant and OR it into the test() call below.
