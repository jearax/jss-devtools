// Centralized logger wrapper around `consola` for consistent output API.
// Pattern adopted from reference repo `/Users/tandm/Documents/jjuidev/npm/jss-cli/src/utils/logger.ts`.
// All CLI output goes through this module — never `console.log` directly.
...
export const logger = {
  ...
  // Raw output — bypass consola for ASCII art (consola breaks multiline chars like figlet output)
